<?php
class Mage_Adminhtml_Block_Dashboard_Tab_Customers_Least extends Mage_Adminhtml_Block_Dashboard_Grid {
	const DEFAULT_PAGE_SIZE      = 5;
	const ORDER_STATUS_COMPLETED = 1;

	public function __construct() {
		parent::__construct();
		$this->setId('customersLeastGrid');
	}
	...
	protected function _prepareCollection() {
		...
		$collection->addFieldToSelect(array('main_account_id' => 'account_id', 'main_account_name' => 'name'))
		           ...
		           ->order('count_referrals ASC')
		           ->order('sum_commission ASC');
	...
	public function getRowUrl($row) {
		return $this->getUrl('affiliateplusadmin/adminhtml_account/edit', array('id' => $row->getAccountId()));
	}
}
