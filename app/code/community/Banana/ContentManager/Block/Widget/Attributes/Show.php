...
class Banana_ContentManager_Block_Widget_Attributes_Show extends Mage_Adminhtml_Block_Template
{
    /**
    ...
    protected function _prepareLayout()
    {
        ...
        $this->setTemplate('banana/contentmanager/widget/attributes_to_show.phtml');
