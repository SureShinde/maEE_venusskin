...
class Banana_ContentManager_Block_Adminhtml_Content extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct(){
        ...
        $this->_headerText = $args[0]['_headerText'];
        $this->_addButtonLabel = $args[0]['_addButtonLabel'];
        parent::__construct();
    }

    public function getCreateUrl()
    {
        return $this->getUrl('*/*/new', array('ct_id' => $this->getRequest()->getParam('ct_id')));
    }
}