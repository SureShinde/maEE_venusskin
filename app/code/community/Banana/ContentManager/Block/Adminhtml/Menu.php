...
class Banana_ContentManager_Block_Adminhtml_Menu extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct(){
        $this->_controller = 'adminhtml_menu';
        $this->_blockGroup = 'contentmanager';
        $this->_headerText = Mage::helper('contentmanager')->__('Menus Manager');
        $this->_addButtonLabel = Mage::helper('contentmanager')->__('Add Menu');
        parent::__construct();
    }
}