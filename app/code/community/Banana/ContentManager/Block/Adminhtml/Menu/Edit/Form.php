...
class Banana_ContentManager_Block_Adminhtml_Menu_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        $form = new Varien_Data_Form(array(
                                        'id' => 'edit_form',
                                        'action' => $this->getUrl('*/*/save', array('menu_id' => $this->getRequest()->getParam('menu_id'))),
                                        'method' => 'post',
                                     )
        );
