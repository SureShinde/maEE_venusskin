...
class Banana_ContentManager_Block_Adminhtml_Review_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('title', array(
            ...
            'align'     =>'left',
            'index'     => 'entity_id',
            'renderer'  => new Banana_ContentManager_Block_Adminhtml_Review_Renderer_Content(),
        ));
