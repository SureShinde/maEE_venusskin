...
class Banana_ContentManager_Block_Adminhtml_Flag_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    public function __construct()
    {
        ...
        $this->setTitle(Mage::helper('contentmanager')->__('Manage flags'));
    }
    ...
    protected function _beforeToHtml()
    {
        $this->addTab('form_section', array(
            ...
            'content'   => $this->getLayout()->createBlock('contentmanager/adminhtml_flag_edit_tab_form')->toHtml(),
        ));
