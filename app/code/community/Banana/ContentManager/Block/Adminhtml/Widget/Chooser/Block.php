...
class Banana_ContentManager_Block_Adminhtml_Widget_Chooser_Block extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _addColumnFilterToCollection($column)
    {
        ...
        if ($column->getId() == 'in_blocks') {
            ...
            if ($column->getFilter()->getValue()) {
                $this->getCollection()->addFieldToFilter('block_id', array('in'=>$selected));
            } else {
                $this->getCollection()->addFieldToFilter('block_id', array('nin'=>$selected));
            }
        } else {
    ...
    protected function _prepareCollection()
    {
        $collection = Mage::getResourceModel('cms/block_collection')
            ->addFieldToSelect(array('title', 'block_id', 'identifier', 'creation_time', 'update_time'));
