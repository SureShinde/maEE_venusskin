...
class Banana_ContentManager_Block_Adminhtml_Contenttype_Edit_Tab_Options_Type_Select extends
    Banana_ContentManager_Block_Adminhtml_Contenttype_Edit_Tab_Options_Type_Abstract
{
    ...
    {
        parent::__construct();
        $this->setTemplate('banana/contentmanager/options/type/select.phtml');
