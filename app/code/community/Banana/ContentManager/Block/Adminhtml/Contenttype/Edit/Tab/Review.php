...
class Banana_ContentManager_Block_Adminhtml_ContentType_Edit_Tab_Review extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset = $form->addFieldset('contenttype_review', array('legend'=>Mage::helper('contentmanager')->__('Reviews')));            

        $fieldset->addField('reviews_enabled', 'select' , array(
            'label'     => Mage::helper('contentmanager')->__('Enabled'),
            'name'      => 'reviews_enabled',
            'options'    => Mage::getSingleton('adminhtml/system_config_source_yesno')->toArray(),
        ));
        
        $fieldset->addField('reviews_default_status', 'select' , array(
