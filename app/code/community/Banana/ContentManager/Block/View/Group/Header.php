...
class Banana_ContentManager_Block_View_Group_Header extends Mage_Catalog_Block_Product_Abstract
{
    protected function _prepareLayout()
    {
        ...
        $this->setTemplate('contenttype/view/group/header-'.$content->getId().'.phtml');
        if(!file_exists(Mage::getBaseDir('app') . DS . 'design' . DS . $this->getTemplateFile()))
        {
            ...
            $this->setTemplate('contenttype/view/group/header-'.$cct->getIdentifier().'.phtml');
            if(!file_exists(Mage::getBaseDir('app') . DS . 'design' . DS . $this->getTemplateFile()))
            {
                //applying default view.phtml
                $this->setTemplate('contenttype/view/group/header.phtml');
            }
        }
    }
