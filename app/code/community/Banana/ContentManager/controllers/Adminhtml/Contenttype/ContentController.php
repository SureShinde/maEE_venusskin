...
class Banana_ContentManager_Adminhtml_ContentType_ContentController extends Mage_Adminhtml_Controller_Action
{
    ...
    */
    ...
    private function _doCrop($imageName, $dimensions, $identifier)
    {
        try {
            ...
            if(file_exists($imagePathFull))
            {
                ...
                $image = new Banana_ContentManager_Model_Image($imagePathFull);
    ...
    protected function _isAllowed()
    {
        ...
        return Mage::getSingleton('admin/session')->isAllowed('contentmanager/content_'.$contentTypeModel->getIdentifier()) || Mage::getSingleton('admin/session')->isAllowed('contentmanager/content_everything');
    }
