 ...
 */
class Banana_ContentManager_Model_Contenttype_Option_Type_Default extends Varien_Object
{
    /**
     * Option Instance
     *
     * @var Banana_ContentManager_Model_Product_Option
     */
    protected $_option;
     ...
     * Product Instance
     *
     * @var Banana_ContentManager_Model_Product
     */
     ...
     *
     * @param Banana_ContentManager_Model_Product_Option $option
     ...
     * @return Banana_ContentManager_Model_Product_Option
     */
    public function getOption()
    {
        if ($this->_option instanceof Banana_ContentManager_Model_ContentType_Option) {
            return $this->_option;
        }
     ...
     *
     * @param Banana_ContentManager_Model_Product $product
     * @return Banana_ContentManager_Model_Product_Option_Type_Default
     */
     ...
     *
     * @throws Mage_Core_Exception
     * @return Banana_ContentManager_Model_Product
     */
    public function getContentType()
    {
        if ($this->_contentType instanceof Banana_ContentManager_Model_ContentType) {
    ...
    public function getSkipCheckRequiredOption()
    {
        return $this->getContentType()->getSkipCheckRequiredOption() ||
            $this->getProcessMode() == Banana_ContentManager_Model_ContentType_Type_Abstract::PROCESS_MODE_LITE;
    }
    ...
    public function getContentTypeOptions()
    {
        if (!isset($this->_contentTypeOptions[$this->getContentType()->getId()])) {
            foreach ($this->getContentType()->getOptions() as $_option) {
                /* @var $option Banana_ContentManager_Model_Product_Option */
                $this->_contentTypeOptions[$this->getContentType()->getId()][$_option->getTitle()] = array('option_id' => $_option->getId());
                if ($_option->getGroupByType() == Banana_ContentManager_Model_ContentType_Option::OPTION_GROUP_SELECT) {
                    $optionValues = array();
                    foreach ($_option->getValues() as $_value) {
                        /* @var $value Banana_ContentManager_Model_Product_Option_Value */
