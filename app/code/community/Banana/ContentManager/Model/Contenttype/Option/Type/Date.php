 ...
 */
class Banana_ContentManager_Model_Contenttype_Option_Type_Date extends Banana_ContentManager_Model_Contenttype_Option_Type_Default
{
    /**
    ...
    public function getFormattedOptionValue($optionValue)
    {
        if ($this->_formattedOptionValue === null) {
            ...
            $option = $this->getOption();
            if ($this->getOption()->getType() == Banana_ContentManager_Model_ContentType_Option::OPTION_TYPE_DATE) {
                $format = Mage::app()->getLocale()->getDateFormat(Mage_Core_Model_Locale::FORMAT_TYPE_MEDIUM);
                $result = Mage::app()->getLocale()->date($optionValue, Zend_Date::ISO_8601, null, false)
                    ->toString($format);
            } elseif ($this->getOption()->getType() == Banana_ContentManager_Model_ContentType_Option::OPTION_TYPE_DATE_TIME) {
            ...
            } elseif ($this->getOption()->getType() == Banana_ContentManager_Model_ContentType_Option::OPTION_TYPE_TIME) {
     ...
     * @return Banana_ContentManager_Model_Product_Option_Type_Date
     */
    ...
    protected function _dateExists()
    {
        return in_array($this->getOption()->getType(), array(
            Banana_ContentManager_Model_ContentType_Option::OPTION_TYPE_DATE,
            Banana_ContentManager_Model_ContentType_Option::OPTION_TYPE_DATE_TIME
        ));
    }
    ...
    protected function _timeExists()
    {
        return in_array($this->getOption()->getType(), array(
            Banana_ContentManager_Model_ContentType_Option::OPTION_TYPE_DATE_TIME,
            Banana_ContentManager_Model_ContentType_Option::OPTION_TYPE_TIME
        ));
    }
}
