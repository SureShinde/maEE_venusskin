...
class Banana_ContentManager_Model_Contenttype_Option extends Mage_Core_Model_Abstract
{
     ...
     *
     * @param Banana_ContentManager_Model_Product_Option_Value $value
     * @return Banana_ContentManager_Model_Product_Option
     */
    public function addValue(Banana_ContentManager_Model_ContentType_Option_Value $value)
    {
     ...
     *
     * @param int $valueId
     * @return Banana_ContentManager_Model_Product_Option_Value
     */
     ...
     * @return Banana_ContentManager_Model_Product_Option
     */
    public function setContentType(Banana_ContentManager_Model_Contenttype $contentType = null)
    {
     ...
     * @return Banana_ContentManager_Model_Product_Option_Group_Abstract
     */
     ...
     *
     * @param Banana_ContentManager_Model_Product $product
     * @return Banana_ContentManager_Model_Resource_Product_Option_Collection
     */
    public function getContentTypeOptionCollection(Banana_ContentManager_Model_Contenttype $contentType)
    {
