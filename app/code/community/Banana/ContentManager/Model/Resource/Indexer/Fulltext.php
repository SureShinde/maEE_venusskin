...
class Banana_ContentManager_Model_Resource_Indexer_Fulltext extends Mage_Core_Model_Mysql4_Abstract
{
    public function _construct(){
            $this->_init('contentmanager/indexer_fulltext', 'fulltext_id');
    }
    
    public function truncate() {
        $this->_getWriteAdapter()->query('TRUNCATE TABLE '.$this->getMainTable());
        $this->changeAutoIncrement(1);
        return $this;
    }
