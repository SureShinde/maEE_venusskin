...
class Banana_ContentManager_Model_Resource_Attribute extends Mage_Eav_Model_Mysql4_Entity_Attribute
{
    /**
     * Perform actions before object save
     *
     * @param Mage_Core_Model_Abstract $object
     * @return Banana_ContentManager_Model_Resource_Attribute
     */
    ...
    protected function _clearUselessAttributeValues(Mage_Core_Model_Abstract $object)
    {
        ...
        if ($object->isScopeGlobal()
            ...
            && Banana_ContentManager_Model_Resource_Eav_Attribute::SCOPE_GLOBAL != $origData['is_global']
        ) {
    ...
    public function deleteEntity(Mage_Core_Model_Abstract $object)
    {
        ...
        if ($result) {
            $attribute = Mage::getSingleton('eav/config')
                ->getAttribute(Banana_ContentManager_Model_Content::ENTITY, $result['attribute_id']);
