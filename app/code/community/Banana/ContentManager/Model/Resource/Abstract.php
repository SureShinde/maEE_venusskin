...
abstract class Banana_ContentManager_Model_Resource_Abstract extends Mage_Eav_Model_Entity_Abstract
{
    /**
    ...
    {
        return Banana_ContentManager_Model_Abstract::DEFAULT_STORE_ID;
    }
     ...
     * @param Banana_ContentManager_Model_Resource_Eav_Attribute $attribute
     * @return boolean
     */
     ...
     *
     * @param Banana_ContentManager_Model_Abstract $object
     * @param array $valueRow
     * @return Banana_ContentManager_Model_Resource_Abstract
     */
     ...
     * @see Banana_ContentManager_Model_Resource_Abstract::_saveAttributeValue()
     *
     * @param Varien_Object $object
     * @param Mage_Eav_Model_Entity_Attribute_Abstract $attribute
     * @param mixed $valueId
    ...
    public function getAttributeRawValue($entityId, $attribute, $store)
    {
        ...
        foreach ($attribute as $_attribute) {
            /* @var $attribute Banana_ContentManager_Model_Entity_Attribute */
