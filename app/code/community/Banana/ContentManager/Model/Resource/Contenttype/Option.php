...
class Banana_ContentManager_Model_Resource_ContentType_Option extends Mage_Core_Model_Mysql4_Abstract
{
    /**
     ...
     *
     * @param Mage_Core_Model_Abstract $object
     * @return Banana_ContentManager_Model_Resource_Product_Option
     */
    protected function _saveValueTitles(Mage_Core_Model_Abstract $object)
    {
        ...
        if (!$object->getData('scope', 'title')) {
            $statement = $readAdapter->select()
                ...
                ->where('store_id  = ?', Banana_ContentManager_Model_Abstract::DEFAULT_STORE_ID);
                ...
                if ($object->getStoreId() == '0') {
                    ...
                    $writeAdapter->update(
                        ...
                        array(
                            ...
                            'store_id  = ?' => Banana_ContentManager_Model_Abstract::DEFAULT_STORE_ID
                        )
                    );
                }
            } else {
