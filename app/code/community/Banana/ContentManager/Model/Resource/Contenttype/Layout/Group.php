...
class Banana_ContentManager_Model_Resource_ContentType_Layout_Group extends Mage_Core_Model_Mysql4_Abstract
{
    /**
    ...
    {
        $this->_init('contentmanager/contenttype_layout_group', 'layout_group_id');
    }
