...
class Banana_ContentManager_Model_Resource_ContentType_Option_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    /**
     ...
     *
     * @param int $storeId
     * @return Banana_ContentManager_Model_Resource_ContentType_Option_Collection
     */
    ...
    public function addTitleToResult($storeId)
    {
        ...
        $this->getSelect()
            ...
            ->where('default_option_title.store_id = ?', Banana_ContentManager_Model_Abstract::DEFAULT_STORE_ID);
    ...
    public function addValuesToResult($storeId = null)
    {
        ...
        if (!empty($optionIds)) {
            /** @var $values Banana_ContentManager_Model_Option_Value_Collection */
     ...
     *
     * @param array|Banana_ContentManager_Model_ContentType|int $contentType
     * @return Banana_ContentManager_Model_Resource_ContentType_Option_Collection
     */
    public function addContentTypeToFilter($contentType)
    {
        ...
        } elseif ($contentType instanceof Banana_ContentManager_Model_Contenttype) {
     ...
     * @return Banana_ContentManager_Model_Resource_Eav_Mysql4_ContentType_Option_Collection
     */
