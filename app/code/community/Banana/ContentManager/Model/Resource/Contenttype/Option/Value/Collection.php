...
class Banana_ContentManager_Model_Resource_ContentType_Option_Value_Collection
    extends Mage_Core_Model_Mysql4_Collection_Abstract
{
     ...
     *
     * @param int $storeId
     * @return Banana_ContentManager_Model_Resource_Product_Option_Value_Collection
     */
    ...
    public function addTitlesToResult($storeId)
    {
        ...
        $this->getSelect()
            ...
            ->where('default_value_title.store_id = ?', Banana_ContentManager_Model_Abstract::DEFAULT_STORE_ID);
     ...
     *
     * @param array|Banana_ContentManager_Model_Product_Option|int $option
     * @return Banana_ContentManager_Model_Resource_Product_Option_Value_Collection
     */
    public function addOptionToFilter($option)
    {
        ...
        } elseif ($option instanceof Banana_ContentManager_Model_ContentType_Option) {
