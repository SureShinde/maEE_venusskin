...
class Banana_ContentManager_Model_Resource_ContentType_Option_Value extends Mage_Core_Model_Mysql4_Abstract
{
    /**
     ...
     *
     * @param int $optionId
     * @return Banana_ContentManager_Model_Resource_Product_Option_Value
     */
