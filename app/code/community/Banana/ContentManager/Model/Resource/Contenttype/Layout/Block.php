...
class Banana_ContentManager_Model_Resource_ContentType_Layout_Block extends Mage_Core_Model_Mysql4_Abstract
{
    /**
    ...
    {
        $this->_init('contentmanager/contenttype_layout_block', 'layout_block_id');
    }
