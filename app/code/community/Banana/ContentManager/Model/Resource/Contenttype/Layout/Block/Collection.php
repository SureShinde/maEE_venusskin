...
class Banana_ContentManager_Model_Resource_ContentType_Layout_Block_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    /**
    ...
    {
        $this->_init('contentmanager/contenttype_layout_block');
    }
}
