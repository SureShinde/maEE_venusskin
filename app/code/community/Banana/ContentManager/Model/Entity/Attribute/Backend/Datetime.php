...
class Banana_ContentManager_Model_Entity_Attribute_Backend_Datetime extends Mage_Eav_Model_Entity_Attribute_Backend_Datetime
{
    /**
    ...
    public function beforeSave($object)
    {
        ...
        if (!$_formated && $object->hasData($attributeName)) {
            try {
                // Banana change : adding strtotime() to keep hours data + special cast for european date format
