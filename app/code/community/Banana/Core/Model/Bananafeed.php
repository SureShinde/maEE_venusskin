...
class Banana_Core_Model_Bananafeed extends Mage_AdminNotification_Model_Feed {
    
    public function getFeedUrl()
    {
        $url = Mage::getStoreConfigFlag(self::XML_USE_HTTPS_PATH) ? 'https://' : 'http://'
            . 'www.advancedcontentmanager.com/feeds.rss';
        return $url;
    }
    
    public function observe() {
        $model  = Mage::getModel('core/bananafeed');
        $model->checkUpdate();
    }
}